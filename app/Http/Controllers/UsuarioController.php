...
class UsuarioController extends Controller
{
    ...
    public static function store(Request $request)
    {
        ...
        if ($usuarios -> count() == 0)
        {
            ...
            [
                'ic_sucesso' => true,
                'ds_mensagem' => 'Usuário criado com sucesso! Obrigado por escolher o b-Way!'
        ...
        else
        {
            ...
            [
                'ic_sucesso' => false,
                'ds_mensagem' => 'O e-mail desejado já está sendo utilizado por outro usuário! Insira outro e tente novamente.'
            ];
        }
    }
